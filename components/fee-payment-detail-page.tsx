          ...
          <Card className="bg-white dark:bg-gray-800 shadow-lg border-0 rounded-2xl overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 text-sm font-medium flex justify-between items-center">
                <span className="text-xs opacity-90 truncate max-w-[70%]">单号：FEE2025052025270586626277394</span>
                <span className="text-amber-600 dark:text-amber-400 font-medium">待缴费</span>
              </div>

              <div className="p-4">
                {/* 商品信息区域 - 添加可点击提示 */}
                <div className="flex space-x-4 mb-4 relative group cursor-pointer">
                  {/* 商品图片 */}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center">
                      ...
                      <ChevronRight className="h-5 w-5 text-gray-400 dark:text-gray-500 flex-shrink-0 ml-1 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
                    </div>
